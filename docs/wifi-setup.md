...
1. The stick displays a **Wi-Fi QR code**. Scan it with your phone’s camera and accept the connection to the temporary `Farphone-xxxx` network. No password typing is needed on supported phones. If your phone reports no Internet connection, choose to stay connected.
